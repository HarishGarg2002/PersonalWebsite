...
export class Terminal extends Component {
  constructor() {
    ...
    this.child_directories = {
      ...
      PDPU: ["Hybrid Neural Networks"],
      books: [
        "Fooled by Randomness_Nassim Taleb.pdf",
        "The Mahabharata.pdf",
        "Econophysics Simplified.pdf",
      ...
      projects: [
        ...
        "PDF GPT",
        "Galactica Fine Tuned",
        "Fusion GPT",
        "Portfolio Optimization Recurrent RL",
        "FinPortRL",
        "Random Numbers",
      ],
      interests: [
    ...
    return (
      <React.Fragment key={id}>
        <div className="flex w-full h-5">
          <div className="flex">
            <div className=" text-ubt-green">Harish@Lenovo</div>
  ...
  handleCommands = (command, rowId) => {
    ...
    switch (main) {
      ...
      case "pwd":
        ...
        result = str.replace("~", "/home/harish");
        break;
      case "code":
        if (words[0] === "." || words.length === 0) {
          ...
          result =
            "Command '" +
            main +
            "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-Harish, todoist, trash, settings, sendmsg]";
        }
        break;
      case "echo":
      ...
      case "about-harish":
        if (words[0] === "." || words.length === 0) {
          this.props.openApp("about-harish");
        } else {
          result =
            "Command '" +
            main +
